...
(function() {
  window.MoviesView = Backbone.View.extend({
    template: _.template('<button type="button" class="btn btn-primary btn-lg all"><h2>Movies</h2></button> <div class="btn-group" role="group" aria-label="button group"><a href="" class="btn btn-default disabled" role="button">Sort:</a><button type="button" class="btn btn-default sort-title">Title</button><button type="button" class="btn btn-default sort-inventory">Inventory</button><button type="button" class="btn btn-default sort-release-date">Release Date</button></div>'),
    events: {
